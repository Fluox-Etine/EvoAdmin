...
CREATE TABLE `evo_sys_log_mysql` (
  ...
  PRIMARY KEY (`id`),
  KEY `uuid` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统sql日志记录';
...
CREATE TABLE `evo_sys_log_request` (
  ...
  `pid` int unsigned NOT NULL DEFAULT '0' COMMENT '进程id',
  `address` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求地址',
  PRIMARY KEY (`id`),
  KEY `uuid` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统请求日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1016 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
INSERT INTO `evo_sys_menu` (`id`, `parent_id`, `path`, `name`, `permission`, `type`, `icon`, `order_no`, `component`, `keep_alive`, `show`, `status`, `is_ext`, `ext_open_mode`, `active_menu`, `created_at`, `updated_at`) VALUES (1014, 1000, '/develop/dict-type', '字段管理', 'develop:dict-type:list', 1, 'ant-design:meh-outlined', 255, 'develop/dict-type/index', 0, 1, 1, 0, 1, NULL, 1726234980, 1726234980);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `evo_sys_role` (`id`, `value`, `name`, `remark`, `status`, `default`, `created_at`, `updated_at`) VALUES (1, 'admin', '管理员', '超级管理员', 1, NULL, 1712679066, 1726380609);
...
INSERT INTO `evo_sys_role_menu` (`role_id`, `menu_id`) VALUES (1, 1014);
INSERT INTO `evo_sys_role_menu` (`role_id`, `menu_id`) VALUES (1, 1015);
...
-- ----------------------------
-- Table structure for evo_sys_slow_sql
-- ----------------------------
DROP TABLE IF EXISTS `evo_sys_slow_sql`;
CREATE TABLE `evo_sys_slow_sql` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `sql` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'sql语句',
  `exec_time` varchar(15) COLLATE utf8mb4_general_ci NOT NULL COMMENT '执行时间',
  `bindings` text COLLATE utf8mb4_general_ci NOT NULL COMMENT '参数',
  `created_at` bigint unsigned NOT NULL COMMENT '分析时间',
  `explain` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '执行结果',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='慢日志分析';

-- ----------------------------
-- Records of evo_sys_slow_sql
-- ----------------------------
BEGIN;
COMMIT;
