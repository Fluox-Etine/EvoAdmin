...
namespace app\generate\service;

use app\generate\service\backend\ControllerService;
use app\generate\service\backend\LogicService;
use app\generate\service\backend\ModelService;
use app\generate\service\backend\RouteService;
use app\generate\service\backend\ValidateService;
use app\generate\service\console\ColumnsService;
use app\generate\service\console\FormSchemasService;
use app\generate\service\console\RequestService;
use app\generate\service\console\TableService;
use support\exception\RespBusinessException;

/**
 * 生成代码服务
 * @package app\generate\service
...
class GenerateService
{
    ...
    {
        if (empty($moduleName)) {
            $tplStr = "namespace app";
        } else {
            $tplStr = "namespace app\\$moduleName";
        }
